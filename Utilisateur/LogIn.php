...
<body>
    ...
    <div class="container">
    	...
    	<?php
        		if(isset($_GET["succes"]))
        		{
        			...
        			if($succes == TRUE)
        			{
        				?>
        				<div class="form-group row justify-content-md-center">
        					<div class="navbar col-sm-4 bg-success ">
        					<h3>Utilisateur crée</h3>	
        				</div>
        				</div>
        			<?php
        			}
      ...
      <form method="POST" action="../listeLecture.php">
        <div class="form-group row justify-content-md-center">
        	<div class="col-sm-4">
        ...
        <div class="form-group row justify-content-md-center">
        	<div class="col-sm-3">
        		<button type="submit" class="btn btn-large btn-primary">Se conecter</button>
        	</div>
        	
        </div>
         <div class="form-group row justify-content-md-center">
        	<div class="col-sm-3">
        		<a href="Creer.php" class="btn btn-large btn-info">Créer un nouvel utilisateur</a>
        	</div>
